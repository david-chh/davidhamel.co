...
export const ui = {
  en: {
    ...
    "footer.newsletter.success": "You're subscribed. Welcome!",
  ...
  de: {
    ...
    "footer.newsletter.success": "Du bist dabei. Willkommen!",
    "footer.newsletter.error": "Etwas ist schiefgelaufen. Bitte versuche es erneut.",
    "footer.copyright": "\u00a9 2026 David Hamel",
